...
<html>
    ...
    <body class="childrenBody">
        <form class="layui-form" style="width:80%;">
            <input type="text" hidden id="id" name="id" value="${(saleChance.id)!}">
            <input type="text" hidden id="man" name="man" value="${(saleChance.assignMan)!}">
            ...
            <div class="layui-form-item layui-row layui-col-xs12">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input"
                            name="overview" value="${(saleChance.overview)!}" id="" placeholder="请输入概要">
                </div>
            </div>
            <div class="layui-form-item layui-row layui-col-xs12">
            ...
            <div class="layui-form-item layui-row layui-col-xs12">
                <div class="layui-input-block">
                    <button class="layui-btn layui-btn-lg" lay-submit="addOrUpdateSaleChance"  lay-filter="addOrUpdateSaleChance">确认 </button>
